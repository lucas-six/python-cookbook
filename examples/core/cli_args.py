...
if __name__ == '__main__':
    ...
    parser.add_argument('arg3', help='argument with value choices', type=str, choices=('a', 'b'))
    ...
    parser.add_argument('--arg10', help='file', type=argparse.FileType('r', encoding='utf-8'))
    ...
    assert len(args.arg7) in (0, 1)
    assert len(args.arg8) == 2
    assert len(args.arg9) > 1
